...
# other_animal = OtherAnimal() # va a fallar porque no se sobre-escribió el método reproduce#                                   ==={Clases abstractas}===
"""
...
#                                   ==={Abstracción}===
'''
La abstracción permite poder trabajar con objetos de manera efectiva sin necesidad de 
conocer todos los detalles internos de los mismos.

Por ejemplo, cuando manejamos un carro, no necesitamos saber cómo funciona su 
motor a nivel interno.
...
'''
Se refiere a que una sintaxis o método con el mismo identificador pueden 
tener comportamientos o formas distintas dependiendo del contexto en que se usen.
